...
\begin{equation}
  \begin{split}
    \tensor{T}&=\pbrac{-p+\lambda\divergence{}{\vectr{v}}}\sharptensor{\tensor{g}}+2\mu\tensor{D} \\
    \tensor{T}&=-p\sharptensor{\tensor{g}}+\mu\pbrac{\pbrac{\gradient{}{\vectr{v}}+\transpose{\gradient{}{\vectr{v}}}}-
      \frac{2}{3}\divergence{}{\vectr{v}}\sharptensor{\tensor{g}}}\\
    \tensor{T}&=-p\sharptensor{\tensor{g}}+\tensor{\tau}
  \end{split}
\end{equation}
