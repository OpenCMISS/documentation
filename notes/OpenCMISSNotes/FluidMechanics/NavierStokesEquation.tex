...
rearranging \Eqnref{eqn:NSEIntegralGenScalarTransport} and using the Green-Gauss
theorem \ie
\begin{equation}
  \begin{split}
    \delby{}{t}\gint{\Omega}{}{\rho\Phi}{\Omega}+\gint{\Gamma}{}{\dotprod{\rho\Phi\vectr{v}}{\vectr{n}}}{\Gamma}
...
semi-implicit pressure correction \citep{chung:2010}.
...
of the PDEs, we refer to \citet{gresho:2000}. From this weak form, we see
...
with additional terms like body forces \citep{heinrich:1999}. These issues can
