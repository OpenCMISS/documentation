...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
which shows that \eqnref{eqn:GeneralisedLaplaceTwoDAnalytic1} satisfies the generalised Laplace equation. TWODO FIX.

The analytic field component definitions in \OpenCMISS are shown in \tabref{tab:OpenCMISSAnalyticFieldGeneralisedLaplaceTwoDim1}.
...
For the case when $H=\dfrac{L}{2}$, $N_{y}=\dfrac{N_{x}}{2}$, $\sigma_{t}=3$, $\sigma_{n}=1$, and $\theta=30\degree$ we have that
...
Now from \eqnref{eqn:FEMTwoDGenLaplaceElementStiffnessMatrix} we have
\begin{equation}
  K_{mn}=\begin{bmatrix}
...
Now, for the case when $H=\dfrac{L}{2}$ and $N_{y}=\dfrac{N_{x}}{2}$ we have that

\begin{equation}
  K_{mn}=\begin{bmatrix}
  \frac{\sigma_{11}+\sigma_{22}}{3} & \frac{\sigma_{11}-2 \sigma_{22}}{6} &
  \frac{-2\sigma_{11}+\sigma_{22}}{6} & \frac{-\sigma_{11}-\sigma_{22}}{6} \\
  \frac{\sigma_{11}-2 \sigma_{22}}{6} & \frac{\sigma_{11}+\sigma_{22}}{3} &
  \frac{-\sigma_{11}-\sigma_{22}}{6} & \frac{-2\sigma_{11}+\sigma_{22}}{6} \\
  \frac{-2\sigma_{11}+\sigma_{22}}{6} & \frac{-\sigma_{11}-\sigma_{22}}{6} &
  \frac{\sigma_{11}+\sigma_{22}}{3} & \frac{\sigma_{11}-2\sigma_{22}}{6} \\
  \frac{-\sigma_{11}-\sigma_{22}}{6} & \frac{-2\sigma_{11}+\sigma_{22}}{6} &
  \frac{\sigma_{11}-2 \sigma_{22}}{6} & \frac{\sigma_{11}+\sigma_{22}}{3}
...
For the case when $\sigma_{t}=3$, $\sigma_{n}=1$, and $\theta=30\degree$ we have that
...
\begin{equation}
  K_{mn}=\begin{bmatrix}
  +\frac{4}{3} & -\frac{1}{12} & -\frac{7}{12} & -\frac{2}{3} \\
