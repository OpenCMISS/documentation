...
For a first order in time approximation we can form Taylor's series expansions for
...
\begin{equation}
  ...
  \pbrac{\Delta t-\tau}\fnof{\dot{\vectr{g}}}{\fnof{\vectr{u}}{t_{n}+\tau}}+\orderof{\tau^{2}}
  \label{eqn:firstordernextTaylorexpansion}
\end{equation}

Now if we multiply \eqnref{eqn:firstordercurrentTaylorexpansion} by
$\dfrac{\Delta t -\tau}{\Delta t}$ and multiply
\eqnref{eqn:firstordernextTaylorexpansion} by
$\dfrac{\tau}{\Delta t}$ and sum we obtain
\begin{equation}
...
\begin{equation}
  \gint{0}{\Delta t}{\fnof{W}{\tau}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n}+\tau}}}{\tau}
  =\gint{0}{\Delta t}{\fnof{W}{\tau}
      \pbrac{\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n}}}-\dfrac{\tau}{\Delta t}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n}}}+
        \dfrac{\tau}{\Delta t}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n+1}}}-\orderof{\tau^{2}}}}{\tau}
\end{equation}
and so
\begin{multline}
...
For a second order in time approximation we need to consider three points \ie we can form Taylor's series expansions for
$\fnof{\vectr{g}}{\fnof{\vectr{u}}{t}}$ about the point $\fnof{\vectr{u}}{t_{n}+\tau}$ \ie
\begin{multline}
  \fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n-1}}}=\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n}+\tau}}
...
If we now multiply \eqnref{eqn:secondorderpreviousTaylorexpansion} by
$\dfrac{-\tau\pbrac{\Delta t - \tau}}{2\Delta t^{2}}$,
\eqnref{eqn:secondordercurrentTaylorexpansion} by
$\dfrac{\pbrac{\Delta t - \tau}\pbrac{\Delta t + \tau}}{\Delta t^{2}}$,
\eqnref{eqn:secondordernextTaylorexpansion} by
$\dfrac{\tau\pbrac{\Delta t + \tau}}{2\Delta t^{2}}$ and sum the equations we obtain
\begin{multline}
...
\begin{multline}
  \gint{0}{\Delta
    t}{\fnof{W}{\tau}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n}+\tau}}}{\tau} = 
  \dintl{0}{\Delta t}\,\fnof{W}{\tau}\left(\dfrac{-\tau}{2\Delta t}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n-1}}}
    +\dfrac{\tau^{2}}{2\Delta
      t^{2}}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n-1}}}+\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n}}}\right. \\
    \left.\dfrac{-\tau^{2}}{\Delta t^{2}}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n}}} + 
  \dfrac{\tau}{\Delta t}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n+1}}} +
  \dfrac{\tau^{2}}{2\Delta t^{2}}\fnof{\vectr{g}}{\fnof{\vectr{u}}{t_{n+1}}}-
...
and
\begin{equation}
\theta_{2}=\dfrac{\gint{0}{\Delta t}{\fnof{W}{\tau}\tau^{2}}{\tau}}{\Delta t^{2}\gint{0}{\Delta t}{\fnof{W}{\tau}}{\tau}}
\end{equation}
...
For a first order approximation in time \eqnref{eqn:dynamic1} now becomes
\begin{multline}
  \matr{M}\pbrac{\ddot{\bar{\vectr{u}}}_{n+1}+\dfrac{\theta_{p-2}{\Delta
        t}^{p-2}}{\factorial{p-2}}\vectr{\alpha}^{p}_{n}}+
  \matr{C}\pbrac{\dot{\bar{\vectr{u}}}_{n+1}+\dfrac{\theta_{p-1}{\Delta
...
\end{multline}
or for a second order approximation in time \eqnref{eqn:dynamic1} now becomes
\begin{multline}
  \matr{M}\pbrac{\ddot{\bar{\vectr{u}}}_{n+1}+\dfrac{\theta_{p-2}{\Delta
        t}^{p-2}}{\factorial{p-2}}\vectr{\alpha}^{p}_{n}}+
  \matr{C}\pbrac{\dot{\bar{\vectr{u}}}_{n+1}+\dfrac{\theta_{p-1}{\Delta
...
\end{multline}
as $\fnof{\vectr{u}}{t_{n-1}}=\vectr{u}_{n-1}$,
...
\begin{multline}
  \fnof{\vectr{\psi}}{\vectr{\alpha}^{p}_{n}}=\pbrac{\dfrac{\theta_{p-2}{\Delta
        t}^{p-2}}{\factorial{p-2}}\matr{M}+\dfrac{\theta_{p-1}{\Delta
        t}^{p-1}}{\factorial{p-1}}\matr{C}+\dfrac{\theta_{p}{\Delta
        t}^{p}}{p!}\matr{K}}\vectr{\alpha}^{p}_{n}+\dfrac{\pbrac{\theta_{2}+\theta_{1}}}{2}\fnof{\vectr{g}}{\hat{\vectr{u}}_{n+1}+
    \dfrac{{\Delta t}^{p}}{p!}\vectr{\alpha}^{p}_{n}}
...
\dfrac{\pbrac{\theta_{2}+\theta_{1}}}{2}\fnof{\vectr{g}}{\hat{\vectr{u}}_{n+1}+
  \dfrac{{\Delta
      t}^{p}}{p!}\vectr{\alpha}^{p}_{n}}+\pbrac{1-\theta_{2}}\fnof{\vectr{g}}{\vectr{u}_{n}}+
