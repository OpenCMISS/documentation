...
\begin{figure}[htpb] \centering
  \input{datafitting/figs/linfieldfit.pstex}
...
\figref{fig:linfieldfit}.  \todo{check capital?}  \eqref{eqn:linfieldfiteqn}
...
hand sides, respectively, of \bref{eqn:linfieldfiteqn} are
\begin{equation}
...
\begin{figure}[htpb] \centering
%  \input{datafitting/figs/polargeomfit.pstex}
...
\begin{figure}[htbp] \centering
  \input{datafitting/figs/cubichermiteelem.pstex}
...
\begin{figure} \centering
  \input{datafitting/figs/datapos.pstex}
...
\begin{figure} \centering
  \input{datafitting/figs/fitting.pstex}
...
iteration (\ie the problem as described in \secref{sec:probform}) the
