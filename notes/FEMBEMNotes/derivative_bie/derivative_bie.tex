...
Taking the directional derivative of (\ref{eqn:closed}) at $P_{0}$ in an
...
now we leave these general), \Eqnref{eqn:result} becomes
\begin{eqnarray}
...
\begin{figure}
\centering
 \input{figs/derivative_bie/elemsplitting.pstex}
...
\begin{figure}
\centering
 \input{figs/derivative_bie/hermitesectors.pstex}
...
With reference to \Figref{fig:hermitesectors}~a, we construct the appropriate
...
Again, with reference to \Figref{fig:hermitesectors}~b, we construct the appropriate
