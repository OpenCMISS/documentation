...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/1Dfield.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/Tempmeas.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/Linearbf.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/Relationship.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/Tmfit.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/Weighting.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/xandurel.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/1DQbf.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/2Dbbf.pstex}
...
%  \begin{figure}[htbp] \centering
%    \input{fem_basis_fns/figs/egdiag1.pstex}
%    \caption{Node positions for example $111$.}
%    \label{fig:example111_node}
%  \end{figure}
%   \begin{figure}[hbtp] \centering
%    \input{fem_basis_fns/figs/egdiag2.pstex}
...
%\begin{figure}[htbp] \centering
%    \input{fem_basis_fns/figs/egdiag3.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/6node.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/8nte.pstex}
...
\index{Basis functions|(}\index{Basis functions!Hermite!cubic|(}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/cubic.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/interpol.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/surface.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/areacoord.pstex}
...
\figref{fig:6nodeqt}.
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/6nodeqt.pstex}
...
%  \begin{figure}[htbp] \centering
%    \input{fem_basis_fns/figs/egdiag5.pstex}
%    \label{fig:egdiag5}
%  \end{figure} 
%  \label{sec:Deftem} 
%\end{example}
...
\begin{figure}[htbp] \centering
 \input{fem_basis_fns/figs/defca.pstex}
...
\begin{figure}[htbp] \centering
  \input{fem_basis_fns/figs/Psc.pstex}
...
\begin{figure}[h] \centering
  \input{fem_basis_fns/figs/spse.pstex}
...
\item  To refine a mesh run the CMISS example $113$. After the first refine the
  ...
  \end{figure}
  \begin{figure}[htbp] \centering
    \input{fem_basis_fns/figs/egdiag4.pstex}
