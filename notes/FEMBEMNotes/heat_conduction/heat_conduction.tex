...
\begin{figure} \centering
 \input{heat_conduction/figs/assembly.pstex}
...
\figref{fig:f.e.soln}.
\begin{figure} \centering
  \input{heat_conduction/figs/fesoln.pstex}
...
\begin{figure} \centering
  \input{heat_conduction/figs/galerkin.pstex}
...
\pstexfigure{heat_conduction/figs/regionbdy.pstex}{}{The region $\Omega$ and
...
\pstexfigure{heat_conduction/figs/mapping.pstex}{}{Mapping each $\Omega$ to the
...
\pstexfigure{heat_conduction/figs/heatflow.pstex}{}{Considering heat flow in a unit square.}
   {fig:heatflow}
...
\pstexfigure{heat_conduction/figs/assemble.pstex}{}{Assembling $4$ unit sized elements into a
  global stiffness matrix.}{fig:assemble}{1.0}
...
\pstexfigure{heat_conduction/figs/zeroflux.pstex}{}{``Cancelling'' of flux in internal nodes.}
   {fig:zeroflux}{1.0}
\begin{description}
...
weights).
\begin{figure} \centering
  \input{heat_conduction/figs/Gaussq.pstex}
