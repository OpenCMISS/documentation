...
\newcommand{\directionalderiv}[2]{\ensuremath{
    \sqfnof{\fnof{D}{#1}}{#2}
}} % directional derivative e.g., \directionalderiv{f}{u} => D(f)[u]
...
\newcommand{\linearisation}[3]{ %
  \ifthenelse{\equal{#2}{}}{ %
    \ensuremath{\sqfnof{\fnof{L}{#1}}{#3}}
  }{
    \ensuremath{\sqfnof{\fnof{L_{#2}}{#1}}{#3}} % 
  }} % linearisation e.g. \linearisation{f}{}{u} => L(f)[u] & \linearisation{f}{x}{u} => L_x(f)[u]
...
\newcommand{\tensorprod}[2]{\ensuremath{ %
    #1 \otimes #2 %
  }} % tensor product e.g., \tensorprod{a}{b} => a x b.
