...
\newcommand{\Inkscape}{\textsf{Inkscape}\xspace}
...
\newcommand{\Appendref}[1]{Appendix~\ref{#1}} % Appendix reference
\newcommand{\appendrefstwo}[2]{Appendices~\ref{#1} and~\ref{#2}} % Appendices ref. two
\newcommand{\Appendrefstwo}[2]{Appendices~\ref{#1} and~\ref{#2}} % Appendices ref. two
\newcommand{\appendrefsthree}[3]{Appendices~\ref{#1}, \ref{#2}, and~\ref{#3}} % Appendices ref. three
\newcommand{\Appendrefsthree}[3]{Appendices~\ref{#1}, \ref{#2}, and~\ref{#3}} % Appendices ref. three
\newcommand{\appendrefsfour}[4]{Appendices~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Appendices ref. four
\newcommand{\Appendrefsfour}[4]{Appendices~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Appendices ref. four
\newcommand{\appendrefs}[2]{\appendrefstwo{#1}{#2}} % Appendices ref.
\newcommand{\Appendrefs}[2]{\Appendrefstwo{#1}{#2}} % Appendices ref.
\newcommand{\appendthrurefs}[2]{Appendices~\ref{#1}--\ref{#2}} % Appendices-- ref.
\newcommand{\Appendthrurefs}[2]{Appendices~\ref{#1}--\ref{#2}} % Appendices-- ref.
...
\newcommand{\Chapref}[1]{Chapter~\ref{#1}} % Chapter reference
\newcommand{\chaprefstwo}[2]{Chapters~\ref{#1} and~\ref{#2}} % Chapters reference two
\newcommand{\Chaprefstwo}[2]{Chapters~\ref{#1} and~\ref{#2}} % Chapters reference two
\newcommand{\chaprefsthree}[3]{Chapters~\ref{#1}, \ref{#2}, and~\ref{#3}} % Chapters reference three
\newcommand{\Chaprefsthree}[3]{Chapters~\ref{#1}, \ref{#2}, and~\ref{#3}} % Chapters reference three
\newcommand{\chaprefsfour}[4]{Chapters~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Chapters reference four
\newcommand{\Chaprefsfour}[4]{Chapters~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Chapters reference four
\newcommand{\chaprefs}[2]{\chaprefstwo{#1}{#2}} % Chapters reference
\newcommand{\Chaprefs}[2]{\Chaprefstwo{#1}{#2}} % Chapters reference
\newcommand{\chathrurefs}[2]{Chapters~\bref{#1}--\bref{#2}} % Chapters-- ref.
\newcommand{\Chathrurefs}[2]{Chapters~\bref{#1}--\bref{#2}} % Chapters-- ref.
\newcommand{\eqnref}[1]{Equation~\bref{#1}} % Equation reference
\newcommand{\Eqnref}[1]{Equation~\bref{#1}} % Equation reference
\newcommand{\eqnrefstwo}[2]{Equations~\bref{#1} and~\bref{#2}} % Equations ref. two
\newcommand{\Eqnrefstwo}[2]{Equations~\bref{#1} and~\bref{#2}} % Equations ref. two
\newcommand{\eqnrefsthree}[3]{Equations~\bref{#1}, \bref{#2}, and~\bref{#3}} % Equations ref. three
\newcommand{\Eqnrefsthree}[3]{Equations~\bref{#1}, \bref{#2}, and~\bref{#3}} % Equations ref. three
\newcommand{\eqnrefsfour}[4]{Equations~\bref{#1}, \bref{#2}, \bref{#3}, and~\bref{#4}} % Equations ref. four
\newcommand{\Eqnrefsfour}[4]{Equations~\bref{#1}, \bref{#2}, \bref{#3}, and~\bref{#4}} % Equations ref. four
\newcommand{\eqnrefs}[2]{\eqnrefstwo{#1}{#2}} % Equations ref.
\newcommand{\Eqnrefs}[2]{\Eqnrefstwo{#1}{#2}} % Equations ref.
\newcommand{\eqnthrurefs}[2]{Equations~\bref{#1}--\bref{#2}} % Equations-- ref.
\newcommand{\Eqnthrurefs}[2]{Equations~\bref{#1}--\bref{#2}} % Equations-- ref.
\newcommand{\figref}[1]{Figure~\ref{#1}} % Figure reference
\newcommand{\Figref}[1]{Figure~\ref{#1}} % Figure reference
\newcommand{\figrefstwo}[2]{Figures~\ref{#1} and~\ref{#2}} % Figures reference two
\newcommand{\Figrefstwo}[2]{Figures~\ref{#1} and~\ref{#2}} % Figures reference two
\newcommand{\figrefsthree}[3]{Figures~\ref{#1}, \ref{#2}, and~\ref{#3}} % Figures reference three
\newcommand{\Figrefsthree}[3]{Figures~\ref{#1}, \ref{#2}, and~\ref{#3}} % Figures reference three
\newcommand{\figrefsfour}[4]{Figures~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Figures reference four
\newcommand{\Figrefsfour}[4]{Figures~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Figures reference four
\newcommand{\figrefs}[2]{\figrefstwo{#1}{#2}} % Figures reference
\newcommand{\Figrefs}[2]{\Figrefstwo{#1}{#2}} % Figures reference
...
\newcommand{\tabrefstwo}[2]{Tables~\ref{#1} and~\ref{#2}} % Tables reference two
\newcommand{\Tabrefstwo}[2]{Tables~\ref{#1} and~\ref{#2}} % Tables reference two
\newcommand{\tabrefsthree}[3]{Tables~\ref{#1}, \ref{#2}, and~\ref{#3}} % Tables reference three
\newcommand{\Tabrefsthree}[3]{Tables~\ref{#1}, \ref{#2}, and~\ref{#3}} % Tables reference three
\newcommand{\tabrefsfour}[4]{Tables~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Tables reference four
\newcommand{\Tabrefsfour}[4]{Tables~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Tables reference four
\newcommand{\tabrefs}[2]{\tabrefstwo{#1}{#2}} % Tables reference
\newcommand{\Tabrefs}[2]{\Tabrefstwo{#1}{#2}} % Tables reference
...
\newcommand{\degK}{\units{K}} % "degrees" Kelvin
% Concentration
\newcommand{\mM}{\units{mM}} % milliMolar
\newcommand{\nM}{\units{nM}} % nanoMolar
...
\newcommand{\octonionnums}{\ensuremath{ %
    \mathbb{O} %
  }} % Octonion numbers
...
\newcommand{\quaternion}[1]{\ensuremath{ %
  \boldsymbol{\textrm{#1}} %
}} %% quaternion number format e.g. \quaternion{i} => i
