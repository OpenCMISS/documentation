...
\newcommand{\liebracket}[2]{\ensuremath{\sqbrac{#1,#2}}} % Lie bracket e.g.,
                                % \liebracket{X}{Y} => [X,Y]
\newcommand{\liederiv}[2]{\ensuremath{\mathcal{L}_{#1} #2}} % Lie derivative
                                % e.g., \liederiv{X}{Y} => L_{X} Y
...
\newcommand{\exteriorscalarderivop}[0]{\ensuremath{ %
    \mathrm{d} %
