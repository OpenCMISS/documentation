...
% Latin abbreviations
%
\newcommand{\eg}{\emph{e.g.,}\xspace} % e.g., exempli gratia
\newcommand{\apriori}{\emph{a priori}\xspace} % a priori
\newcommand{\etal}{\emph{et al.}\xspace} % et al., et alii
\newcommand{\etc}{\emph{etc.}\xspace} % etc., et cetera
\newcommand{\ie}{\emph{i.e.,}\xspace} % i.e., id est
\newcommand{\nb}{\emph{n.b.}\xspace} % n.b., nota bene
\newcommand{\cf}{\emph{cf.}\xspace} % cf., confer
\newcommand{\vs}{\emph{vs.}\xspace} % vs., versus
%
